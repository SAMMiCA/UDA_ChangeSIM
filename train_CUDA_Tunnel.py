...
def main():
    ...
    target_dataset = TunnelDataset(target_path, crop_size=input_size, num_classes=num_classes, ignore_label=255, max_iters=args.num_steps * args.batch_size, set='train', mode='target')

    val_dataset = TunnelDataset(data_path, crop_size=input_size, ignore_label=255, num_classes=num_classes, set='test')
